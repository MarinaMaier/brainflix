            ...
            <form className="form__wrapper">
                ...
                <div className="form__container">
                    <div className="form__container-desktop">
                        ...
                        <input placeholder="Add a new comment" className="form__comment-input" id="user-comment" type="text"
                            name="text"/>
                        <p id="add-user-form-errors"></p>
                        </div>
                    <div className="form__btn">
                        <button type="submit" className="form__btn__comment">COMMENT</button>
                    </div>
                </div>
            </form>
